...
<!--使用TasksController-->
	  ...
	  <script type="text/javascript">
		...
		function agree(id){
//			alert('确定审核通过?');
			window.location.href="auditAction!allowTask?foo.id="+id;
		}
		function disagree(id){
			alert('否决通过?');
			window.location.href="auditAction!denyTask?foo.id="+id;
		}
		function deleteFoo(id){
			alert('确定删除?');
			window.location.href="auditAction!deleteTask?foo.id="+id;
		}
